...
class ResumeKkPage extends StatefulWidget {
  final int id;
  const ResumeKkPage({super.key, required this.id});

  @override
  State<ResumeKkPage> createState() => _ResumeKkPageState();
}

class _ResumeKkPageState extends State<ResumeKkPage> {
          ...
          return pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                _pdfInfo("Jenis KK", data?['jenis_kk'] ?? '-', font, fontBold),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfo("Jenis KK", data?['jenis_kk'] ?? '-'),
