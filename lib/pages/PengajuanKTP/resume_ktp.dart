...
class ResumeKtpPage extends StatefulWidget {
  final int id;
  const ResumeKtpPage({super.key, required this.id});

  @override
  State<ResumeKtpPage> createState() => _ResumeKtpPageState();
}

class _ResumeKtpPageState extends State<ResumeKtpPage> {
  ...
  Future<void> fetchResume() async {
    ...
    try {
      final res = await http.get(
        Uri.parse("http://10.0.2.2:8000/api/pengajuan_ktp/${widget.id}"),
        headers: {
        ...
        build: (context) {
          return pw.Container(
            decoration: pw.BoxDecoration(
              color: PdfColor.fromHex("#F5FAFF"), // biru muda lembut
            ...
            child: pw.Column(
              ...
              children: [
                pw.Row(
                  ...
                  children: [
                    pw.Text(
                      "Resume Pendaftaran Antrean KTP",
                      style: pw.TextStyle(
                        font: fontBold,
                        fontSize: 22,
                        color: primaryColor,
                ...
                _pdfInfo("Nomor Antrian", data?['nomor_antrean'] ?? '-', font, fontBold),
                ...
                _pdfInfo("Jenis KTP", data?['jenis_ktp'] ?? '-', font, fontBold),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfo("Jenis KTP", data?['jenis_ktp'] ?? '-'),
